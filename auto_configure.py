# -*- coding: utf-8 -*-
"""
自动通道配置工具 (auto_configure.py) 交互式版，双语版
...
def main():
    ...
    if args.folder is None:
        # 交互模式
        print("自动通道配置工具（交互式） / Auto Channel Configuration (Interactive)")
        ...
        print("Force overwrite existing configuration file? (y/n, default n):")
